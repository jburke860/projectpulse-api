  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className="pp-card pp-dialog-enter fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 overflow-y-auto p-6 shadow-2xl"
      >
