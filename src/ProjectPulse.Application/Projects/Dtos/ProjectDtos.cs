...
public record ProjectDto(Guid Id, string Name, string? Description, string Status, DateTime CreatedAtUtc, int MemberCount, int TaskCount);
...
public record CreateProjectRequest(string Name, string? Description, string? Status = null);
